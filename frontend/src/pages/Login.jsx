  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <button type="button" className="btn btn-outline btn-block" style={{ marginBottom: '1rem', display: 'flex', gap: '10px', alignItems: 'center', justifyContent: 'center' }} onClick={handleGoogleLogin}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '1.5rem 0', color: 'var(--text-tertiary)', fontSize: '0.8rem' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input id="login-email" type="email" className="form-input" placeholder="you@example.com" required value={email} onChange={e => setEmail(e.target.value)} />
          </div>
          <div className="form-group">
            <label className="form-label" htmlFor="login-password">Password</label>
            <input id="login-password" type="password" className="form-input" placeholder="••••••••" required minLength={6} value={password} onChange={e => setPassword(e.target.value)} />
          </div>
