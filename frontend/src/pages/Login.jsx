...
export default function Login() {
  ...
  return (
    <div className="landing-page-root min-h-screen flex items-center justify-center p-5 relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[var(--ld-primary)] opacity-[0.15] blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-[var(--ld-primary-light)] opacity-[0.1] blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-[var(--ld-card)] border border-[var(--ld-border)] rounded-2xl p-8 md:p-10 ld-shadow-card">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[var(--ld-text)] mb-2">Welcome back</h1>
            <p className="text-sm text-[var(--ld-text-secondary)]">Sign in to continue your habit journey</p>
          </div>
          ...
          {!showEmailForm ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                <label className="block text-[13px] font-semibold text-[var(--ld-text-secondary)] mb-1.5" htmlFor="login-email">Email Address</label>
              ...
              <div>
                <label className="block text-[13px] font-semibold text-[var(--ld-text-secondary)] mb-1.5" htmlFor="login-password">Password</label>
          ...
          <p className="text-center mt-8 text-[13px] text-[var(--ld-text-secondary)]">
            Don't have an account? <Link to="/register" className="text-[var(--ld-primary-light)] hover:text-[var(--ld-primary)] font-semibold transition-colors">Create one</Link>
          </p>
        </div>
      </div>
    </div>
